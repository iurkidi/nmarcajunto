...
use uni\bundle\nmarcaJuntoBundle\Form\categoriasType;
...
class categoriasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniNmarcaJuntoBundle:categorias')->findAll();

        return $this->render('uniNmarcaJuntoBundle:categorias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniNmarcaJuntoBundle:categorias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniNmarcaJuntoBundle:categorias')->find($id);
        ...
        return $this->render('uniNmarcaJuntoBundle:categorias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniNmarcaJuntoBundle:categorias:edit.html.twig', array(
            'entity'      => $entity,
