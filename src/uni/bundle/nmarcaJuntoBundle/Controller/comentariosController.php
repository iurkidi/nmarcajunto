...
use uni\bundle\nmarcaJuntoBundle\Form\comentariosType;
...
class comentariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniNmarcaJuntoBundle:comentarios')->findAll();

        return $this->render('uniNmarcaJuntoBundle:comentarios:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniNmarcaJuntoBundle:comentarios:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniNmarcaJuntoBundle:comentarios')->find($id);
        ...
        return $this->render('uniNmarcaJuntoBundle:comentarios:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniNmarcaJuntoBundle:comentarios:edit.html.twig', array(
            'entity'      => $entity,
